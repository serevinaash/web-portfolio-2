...
const socialLinks = [
    { platform: "GitHub", href: "https://github.com/serevinaash", iconPath: "/icons/github_icon.svg" }, // <-- Replace YOUR_GITHUB_LINK and icon path
    { platform: "LinkedIn", href: "https://www.linkedin.com/in/serevinasherly/", iconPath: "/icons/linkedin_icon.svg" }, // <-- Replace YOUR_LINKEDIN_LINK and icon path
    { platform: "Gmail", href: "mailto:serevinasherly01@gmail.com", iconPath: "/icons/gmail_icon.svg" }, // <-- Replace YOUR_EMAIL_ADDRESS and icon path
];

// Define contact information
const contactInfo = {
    email: "serevinasherly01@gmail.com",
};
